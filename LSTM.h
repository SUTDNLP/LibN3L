...
public:
  ...
  LSTM(LSTM &obj) {
    _lstm_output = obj._lstm_output;
    _lstm_input = obj._lstm_input;
    _lstm_forget = obj._lstm_forget;
    _lstm_cell = obj._lstm_cell;
    _left2right = obj._left2right;
    _null1 = obj._null1;
    _null1Loss = obj._null1Loss;
    _null2 = obj._null2;
    _null2Loss =obj._null2Loss;
  }

  inline void initial(int outputsize, int inputsize, int seed = 0) {
    _left2right = true;

    _lstm_output.initial(outputsize, outputsize, inputsize, true, seed, 0);
    _lstm_input.initial(outputsize, outputsize, inputsize, true, seed + 10, 0);
    _lstm_forget.initial(outputsize, outputsize, inputsize, true, seed + 20, 0);
  ...
  inline void initial(Tensor<xpu, 2, dtype> cWL, Tensor<xpu, 2, dtype> cWR, Tensor<xpu, 2, dtype> cb, Tensor<xpu, 2, dtype> oW1, Tensor<xpu, 2, dtype> oW2,
    ...
    _lstm_output.initial(oW1, oW2, oW3, ob, true);
    _lstm_input.initial(iW1, iW2, iW3, ib, true);
    _lstm_forget.initial(fW1, fW2, fW3, fb, true);
...
public:
  ...
  inline void ComputeForwardScoreIncremental(Tensor<xpu, 2, dtype> x, Tensor<xpu, 2, dtype> iy, Tensor<xpu, 2, dtype> oy, Tensor<xpu, 2, dtype> mcy,
      Tensor<xpu, 2, dtype> cy, Tensor<xpu, 2, dtype> my, Tensor<xpu, 2, dtype> y) {
    assert(_left2right);
