...
public:
  ...
  void writeModel(LStream &outf) {
    ...
    // cout << "tagBigram " << _tagBigram.size(0) << " and " << _tagBigram.size(1) << endl;
    // cout << "_grad_tagBigram " << _grad_tagBigram.size(0) << " and " << _grad_tagBigram.size(1) << endl;
    // cout << "_eg2_tagBigram " << _eg2_tagBigram.size(0) << " and " << _eg2_tagBigram.size(1) << endl;
  }
