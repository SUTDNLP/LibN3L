...
#ifndef SRC_TriLayerLSTM_H_
#define SRC_TriLayerLSTM_H_
#include "tensor.h"
#include "MyLib.h"
...
public:
  ...
  TriLayerLSTM(TriLayerLSTM &obj) {
    ...
    _eg2b = obj._eg2b;
    _bUseB = obj._bUseB;
    _funcType = obj._funcType;

  }

  inline void initial(int nOSize, int nISize1, int nISize2, bool bUseB = true, int seed = 0, int funcType = 0) {
    dtype bound = sqrt(6.0 / (nOSize + nISize1 + nISize2 + 1));
    //dtype bound = 0.01;
    ...
    _W3 = NewTensor<xpu>(Shape2(1, nOSize), d_zero);
    _gradW3 = NewTensor<xpu>(Shape2(1, nOSize), d_zero);
    _eg2W3 = NewTensor<xpu>(Shape2(1, nOSize), d_zero);
  ...
  inline void initial(Tensor<xpu, 2, dtype> W1, Tensor<xpu, 2, dtype> W2, Tensor<xpu, 2, dtype> W3, Tensor<xpu, 2, dtype> b, bool bUseB = true,
      int funcType = 0) {
    static int nOSize, nISize1, nISize2;
    nOSize = W1.size(0);
    nISize1 = W1.size(1);
    nISize2 = W2.size(1);
